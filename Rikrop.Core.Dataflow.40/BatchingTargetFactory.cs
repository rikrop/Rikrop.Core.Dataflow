...
namespace Rikrop.Core.Dataflow
{
    ...
    {
        private readonly ITargetFactory<TKey, IEnumerable<TItem>> _targetFactory;
        ...
        public BatchingTargetFactory(ITargetFactory<TKey, IEnumerable<TItem>> targetFactory, int batchSize, TimeSpan forceSendTimeout, IExceptionHandler exceptionHandler)
        {
