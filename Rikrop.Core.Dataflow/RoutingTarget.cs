...
namespace Rikrop.Core.Dataflow
{
    ...
    {
        private readonly IReadOnlyCollection<ISelectiveTarget<TItem>> _targets;
        ...
        public RoutingTarget(IReadOnlyCollection<ISelectiveTarget<TItem>> targets)
        {
            Contract.Requires<ArgumentNullException>(targets != null);
            Contract.Requires<ArgumentNullException>(targets.Count > 0);
