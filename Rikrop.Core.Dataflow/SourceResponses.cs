...
namespace Rikrop.Core.Dataflow
{
    ...
    public static class SourceResponses
    {
        ...
        public static SourceResponse<IReadOnlyCollection<TItem>> CollectionBasedResponse<TItem>(IReadOnlyCollection<TItem> items)
        {
            return items == null || items.Count == 0
                       ? EmptyResponse<IReadOnlyCollection<TItem>>()
